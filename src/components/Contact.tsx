...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-container bg-gray-50 dark:bg-gray-800 py-16">
      <h2 className="section-title text-center text-3xl font-semibold text-gray-900 dark:text-white mb-8">
        Entre em Contato
      </h2>
      <p className="section-subtitle text-center text-lg text-gray-600 dark:text-gray-300 mb-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white focus:outline-none transition-all duration-300 ease-in-out"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white dark:bg-purple-600 dark:hover:bg-purple-700 font-semibold py-3 px-6 rounded-lg transition-all duration-200 ease-in-out"
          >
            Enviar Mensagem
          </button>
        </form>
