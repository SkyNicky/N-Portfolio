...
const About = () => {
  return (
    <section id="about" className="section-container py-16 px-8">
      <h2 className="section-title text-4xl font-extrabold text-center mb-6">Sobre Mim</h2>
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-12">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transition-transform transform hover:scale-105">
          <div className="flex items-center mb-4">
            <Code className="w-8 h-8 text-blue-600 dark:text-purple-500 mr-2 transition-colors hover:text-blue-800" />
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transition-transform transform hover:scale-105">
          <div className="flex items-center mb-4">
            <Briefcase className="w-8 h-8 text-blue-600 dark:text-purple-500 mr-2 transition-colors hover:text-blue-800" />
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transition-transform transform hover:scale-105">
          <div className="flex items-center mb-4">
            <BookOpen className="w-8 h-8 text-blue-600 dark:text-purple-500 mr-2 transition-colors hover:text-blue-800" />
