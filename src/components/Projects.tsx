...
const projects = [
  {
    ...
    description: 'Uma aplicação web desenvolvida com React e JavaScript',
  ...
  {
    title: 'Mix Burguer',
    description: 'Site Fictício De Lanchonete desenvolvido através de um projeto em equipe',
...
const Projects = () => {
  return (
    <section id="projects" className="section-container bg-gray-50 dark:bg-gray-800 py-12">
      <h2 className="section-title text-center">Projetos em Destaque</h2>
      <p className="section-subtitle text-center mb-8 text-lg">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105"
          >
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map((tag, tagIndex) => (
                  <span
                    key={tagIndex}
                    className="px-3 py-1 bg-blue-100 dark:bg-purple-900 text-gray-800 dark:text-gray-200 rounded-full text-sm"
                  >
                    {tag}
                  </span>
                ))}
